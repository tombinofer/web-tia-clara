...
$.extend( $.validator, {
	...
	messages: {
		...
		maxlength: $.validator.format( "Por favor ingrese no más de {0} carácteres." ),
		minlength: $.validator.format( "Introduzca por lo menos {0} carácteres." ),
		rangelength: $.validator.format( "Por favor, introduzca un valor entre {0} y {1} carácteres de largo." ),
